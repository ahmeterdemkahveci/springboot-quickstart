...
public class TopicServiceImpl {
	...
	public void update(String id, Topic topic) {
		...
		//topics.stream().filter(t->t.getId().equals(id)).map(top->new Topic(topic.getId(),topic.getCode(),topic.getDescription())).collect(Collectors.toCollection(ArrayList::new));
